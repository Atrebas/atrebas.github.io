...
### Update
- _2020-07-26_: Update with data.table_1.13.0 (`fcase()`, functions in `.SDcols`) and dplyr_1.0.0 (`across()`, `relocate()`, ...). 'Superseded' dplyr code has been commented and will probably be removed in the future.    
